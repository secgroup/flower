...
type props_types = {
  classes: any;
  onTargetChanged: (a: any) => void;
  hexdump: boolean;
  requestInProgress: boolean;
  onRequestSearch: (a: string) => void;
  toggleHexdump: (a: boolean) => void;
  onTimeSet: (a: number, b: number) => void;
  onServicesFetched: (a: Array<Service_type>) => void;
};
type state_types = {
  from_time: number;
  to_time: number;
        ...
        <FormControlLabel
          control={
            <Checkbox
              ...
              onChange={this.props.toggleHexdump as any}
              value="Hexdump"
            />
          }
