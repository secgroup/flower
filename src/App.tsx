  ...
  render() {
    ...
    const myToolbar = (
      <MyToolbar
        ...
        toggleHexdump={() => this.setState({ hexdump: !this.state.hexdump })}
    ...
    return (
      <div>
        ...
        <div className="row">
          <div className="column_4_small">{left_favourites_bar}</div>
          <div className="column_4_big">{flow_list}</div>
          <div className="column_2">{flow_details}</div>
        </div>
      </div>
    );
  }
